...
![Gráfico de Contribuições](https://ssr-contributions-svg.vercel.app/_/Pereiraa7?chart=3dbar&gap=0.6&scale=2&flatten=2&animation=wave&animation_duration=1&animation_delay=0.05&animation_amplitude=20&animation_frequency=0.5&animation_wave_center=10_0&format=svg&weeks=30&theme=blue)


<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=68D1F7&height=120&section=footer"/>
